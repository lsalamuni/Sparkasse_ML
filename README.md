Build a model f that classifies each e-mail from the Kundenanfrage field into one of the 12 sub-categories in Unterkategorie 2 (e.g. TAN procedure, fees, phishing, ...). 
